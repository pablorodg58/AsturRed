...
<body>
    ...
    <header class="image-banner">
        <img src="img/cabecera-osTeixois.jpg" alt="Castros de Coaña">
        <h2>Os Teixois</h2>
    </header>

    <!-- Contenido principal -->
    <div class="content">
        <h2 class="text-center">Un Lugar Mágico</h2>
        <p>
            Os Teixois es un conjunto etnográfico situado en las proximidades de Taramundi, en la zona occidental de Asturias. Este lugar ofrece una fascinante inmersión en la vida tradicional de la región, mostrando cómo se aprovechaba la fuerza del agua para realizar diversas actividades artesanales.
            <br>
            El conjunto de Os Teixois se compone de varios ingenios hidráulicos, como un mazo, un molino, una rueda de afilar y una central eléctrica, todos ellos impulsados por el agua del arroyo Las Mestas. Estos ingenios permitían a los habitantes de la zona realizar tareas como la fabricación de herramientas, la molienda de cereales y la producción de electricidad de forma sostenible.


        </p>

        <div class="image-container">
            <img src="img/OsTeixois.jpg" alt="Castros de Coaña">
            <img src="img/OsTeixois2.jpg" alt="Paisaje de Castros de Coaña">
        </div>
        <p><br>
            Además de los ingenios hidráulicos, Os Teixois cuenta con una muestra de arquitectura popular asturiana, con casas tradicionales, hórreos y otros elementos que reflejan el modo de vida de la zona. El entorno natural que rodea el conjunto es de gran belleza, con bosques, senderos y el propio arroyo Las Mestas, lo que añade un atractivo adicional a la visita.



            <br>
            Os Teixois es un lugar de gran interés histórico y cultural, que permite a los visitantes conocer de cerca las tradiciones y costumbres de la Asturias rural. Su valor etnográfico y su belleza natural lo convierten en un destino imprescindible para quienes visitan la región.
