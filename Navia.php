        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="content" id="contentSection">
                    <div class="section">
                        ...
                        <p>Navia es un encantador pueblo costero que combina tradición y modernidad. Su historia se remonta a tiempos antiguos, donde la pesca y la agricultura fueron pilares de su economía. Hoy en día, se ha convertido en un destino turístico muy valorado por sus playas y su gastronomía.</p>
                        ...
                        <p>Te invitamos a explorar los hermosos rincones de Navia, desde sus playas de arena dorada hasta sus senderos naturales, ideales para caminatas y paseos en bicicleta. ¡Ven y descubre lo que tenemos para ofrecerte!</p>
                ...
                <div class="section">
                    ...
                    <div class="grid">
                        <div class="grid-item">
                            <img src="img/ParqueHistoricoNavia.jpg" alt="Mercado local">
                            <p>Explora nuestro mercado local.</p>
                        </div>
                        <div class="grid-item">
                            <img src="img/faroNavia.avif" alt="Recetas tradicionales">
                            <p>Prueba nuestras recetas tradicionales.</p>
                        </div>
                        <div class="grid-item">
                            <img src="img/CasinoNavia.jpg" alt="Eventos en el pueblo">
                        ...
                        <div class="grid-item" onclick="window.location.href='CastrosCoaña.php';" style="cursor: pointer; text-decoration: none; color: inherit;">
                            <img src="img/castro-coana.jpg" alt="Naturaleza alrededor del pueblo">
            ...
            <div class="col-md-3">
                <div class="business-container">
                    ...
                    // Obtener los negocios de Navia
                    $query = "SELECT id, username, business_name, profile_pic FROM businesses WHERE address LIKE '%Navia%'";
