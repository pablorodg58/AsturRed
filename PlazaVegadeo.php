...
<body>
    ...
    <header class="image-banner">
        <img src="img/cabecera-Plaza-Vegadeo.jpg" alt="cabecera-Plaza-Vegadeo">
        <h2>Parque del Medal</h2>
    </header>

    <!-- Contenido principal -->
    <div class="content">
        <h2 class="text-center">El Corazon de un Pueblo Tranquilo</h2>
        <p>
        La Plaza de Vegadeo, centro neurálgico de esta villa asturiana, es un espacio que refleja la vida y la historia de la localidad. Esta plaza, punto de encuentro de vecinos y visitantes, se caracteriza por su ambiente animado y acogedor, donde se combinan edificios históricos, comercios y espacios de ocio.



<br>
En el corazón de la plaza, se alza el Ayuntamiento de Vegadeo, un edificio de notable valor arquitectónico que destaca por su fachada porticada y su torre del reloj. Este edificio, que alberga la sede del gobierno local, es un símbolo de la vida política y administrativa de la villa.



<br>La plaza también alberga otros edificios de interés, como casas señoriales y construcciones tradicionales, que reflejan la rica historia de Vegadeo. En sus alrededores, se encuentran comercios, bares y restaurantes, que ofrecen una amplia variedad de productos y servicios.
        ...
        <div class="image-container">
            <img src="img/vegadeoPlaza1.webp" alt="Vaca Vegadeo">
            <img src="img/vegadeoPlaza2.webp" alt="Kiosko vegadeo">
        </div>
        <p><br>
        Vegadeo además cuenta con zonas verdes y parques. El Parque de Medal, por ejemplo, es un espacio verde que ofrece un lugar de esparcimiento y relax para los habitantes de Vegadeo y sus visitantes. Este parque cuenta con zonas de juego para niños, bancos para descansar y áreas ajardinadas donde se puede disfrutar de la naturaleza.
            ...
            <br>
            La Plaza de Vegadeo es un lugar donde se celebran eventos y festividades a lo largo del año, convirtiéndose en un punto de encuentro festivo y dinámico. Su ambiente acogedor y su rica historia hacen de la Plaza de Vegadeo un lugar imprescindible para quienes visitan esta villa asturiana.            
