...
<head>
    ...
    <title>Cristo de Paramios</title>
...
<body>
    ...
    <header class="image-banner">
        <img src="img/cabecera-CristoParamios.jpg" alt="cabecera-Plaza-Vegadeo">
        <h2>Cristo de Paramios</h2>
    </header>
    ...
    <div class="content">
        ...
        <p>
        El Cristo de Paramios es una cruz de piedra de granito que se encuentra en el concejo de Vegadeo. Este crucero, de gran valor histórico y artístico, se ubica al borde del camino que conducía a la antigua alberguería de Paramios, lo que sugiere su importancia como punto de referencia y protección para los viajeros.



<br>
El crucero está compuesto por una base de piedra sobre la que se levanta una columna, rematada por una cruz. La cruz presenta una figura de Cristo crucificado, tallada en la misma piedra. La talla, aunque sencilla, muestra un gran detalle y expresividad, reflejando el estilo artístico de la época en que fue creada.



<br>
El Cristo de Paramios está catalogado en el Inventario del Patrimonio Arquitectónico de Asturias, lo que atestigua su valor cultural y su importancia para la región. Según los registros, el crucero data del siglo XVIII, lo que lo convierte en un testimonio de la historia y las tradiciones de la zona.
        ...
        <div class="image-container">
            <img src="img/CristoParamios2.JPG" alt="Kiosko vegadeo">
            <img src="img/CristoParamios1.JPG" alt="Vaca Vegadeo">
        </div>
        <p><br>
        El entorno en el que se encuentra el Cristo de Paramios es de gran belleza natural, con paisajes de prados y bosques que invitan a la contemplación. La ubicación del crucero, al borde del camino, sugiere que fue un lugar de paso y de oración para los viajeros que recorrían la zona.
            ...
            <br>
            En resumen, el Cristo de Paramios es un crucero de gran valor histórico y artístico, que refleja la tradición y la cultura de la zona de Vegadeo. Su ubicación, su antigüedad y su valor cultural lo convierten en un punto de interés para quienes visitan la región.
