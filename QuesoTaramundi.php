...
<head>
    ...
    <title>Quesos de Taramundi</title>
...
<body>
    ...
    <header class="image-banner">
        <img src="img/cabecera-queso-taramundi.jpg" alt="Castros de Coaña">
        <h2>Quesos de Taramundi</h2>
    </header>

    <!-- Contenido principal -->
    <div class="content">
        <h2 class="text-center">El Queso Tradicional del Occidente Asturiano</h2>
        <p>
        El queso de Taramundi, arraigado en la tradición quesera de la zona occidental de Asturias, es un producto que destaca por su singularidad y sabor distintivo. Elaborado principalmente con leche de vaca, y en ocasiones con mezclas que incluyen leche de cabra, este queso refleja la riqueza de los pastos y la calidad de la ganadería local.

<br>
Su proceso de elaboración sigue métodos artesanales transmitidos de generación en generación, lo que contribuye a su carácter único. La leche, cuidadosamente seleccionada, se somete a un proceso de coagulación y prensado que determina la textura y el sabor final del queso.

<br>El queso de Taramundi se presenta en diversas variedades, desde quesos frescos hasta quesos curados, cada uno con sus propias características organolépticas. Algunos quesos incorporan ingredientes adicionales, como nueces y avellanas, que aportan matices y aromas singulares.
        ...
        <div class="image-container">
            <img src="img/quesoTaramundi2.jpg" alt="Castros de Coaña">
            <img src="img/quesoTaramundi1.webp" alt="Paisaje de Castros de Coaña">
        </div>
        <p><br>
        La zona de Taramundi, con su clima y entorno natural privilegiados, influye de manera determinante en la calidad del queso. Los pastos de montaña, ricos en flora autóctona, confieren a la leche un sabor y aroma característicos que se transmiten al queso.




            <br>
            El queso de Taramundi es un producto versátil que se puede disfrutar de diversas formas, desde degustarlo solo hasta utilizarlo como ingrediente en recetas tradicionales y modernas. Su sabor y textura lo convierten en un elemento imprescindible de la gastronomía asturiana.        <div class="text-center my-4">
