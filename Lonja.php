...
<head>
    ...
    <title>Lonja de Puerto de Vega</title>
...
<body>
    ...
    <header class="image-banner">
        <img src="img/cabecera-Lonja.jpg" alt="Plata Tapia">
        <h2>Lonja Puerto de Vega</h2>
    </header>
    ...
    <div class="content">
        ...
        <p>
        La Lonja de Puerto de Vega es un espacio de gran importancia tanto para la economía local como para la cultura de la región. Este lugar, donde se subasta el pescado fresco capturado por los pescadores de la zona, ofrece una visión auténtica de la vida marinera y del trabajo de los hombres y mujeres del mar.


<br>
La actividad en la Lonja de Puerto de Vega comienza temprano, con la llegada de los barcos de pesca cargados de capturas. Los pescadores descargan su mercancía, que es clasificada y preparada para la subasta. El ambiente es animado y bullicioso, con compradores y vendedores negociando los precios del pescado.


<br>
La Lonja de Puerto de Vega ofrece una amplia variedad de pescado fresco, desde especies locales como la lubina, el besugo y el pixín, hasta mariscos como la nécora y el percebe. La calidad del pescado es excepcional, gracias a las aguas limpias y ricas del mar Cantábrico.
        ...
        <div class="image-container">
            <img src="img/Lonja1.jpg" alt="Castros de Coaña">
            <img src="img/Lonja2.jpg" alt="Paisaje de Castros de Coaña">
        </div>
        <p><br>
        Además de su función comercial, la Lonja de Puerto de Vega también es un lugar de interés turístico. Los visitantes pueden observar la actividad de la subasta, aprender sobre las diferentes especies de pescado y marisco, y conocer de cerca la vida de los pescadores. La Lonja es un lugar ideal para comprar pescado fresco y de calidad, y para disfrutar de la gastronomía local en los restaurantes cercanos.


            <br>
            La Lonja de Puerto de Vega es un espacio que refleja la tradición marinera de la villa y que ofrece una experiencia auténtica y enriquecedora para quienes la visitan.            
