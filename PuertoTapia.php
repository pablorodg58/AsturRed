...
<body>
    ...
    <header class="image-banner">
        <img src="img/cabecera-puerto-tapia.jpg" alt="Puerto de Tapia">
        <h2>Puerto de Tapia</h2>
    </header>

    <!-- Contenido principal -->
    <div class="content">
        <h2 class="text-center">Conecta con la Costa y la Brisa Marina</h2>
        <p>
        El puerto de Tapia de Casariego es un punto neurálgico que combina tradición marinera, actividad pesquera y atractivo turístico. Este puerto, con una historia que se remonta a siglos atrás, ha sido testigo del desarrollo de Tapia como villa marinera y ha desempeñado un papel fundamental en su economía y su cultura.



<br>
El puerto de Tapia se caracteriza por su ambiente animado y pintoresco, con embarcaciones pesqueras que faenan a diario y con una lonja donde se subasta el pescado fresco. Los visitantes pueden pasear por el muelle, observar la actividad de los pescadores y disfrutar de las vistas del mar Cantábrico.



<br>Además de su función pesquera, el puerto de Tapia también alberga un puerto deportivo, que ofrece servicios a embarcaciones de recreo y que contribuye a dinamizar la actividad turística de la villa. El puerto deportivo es un punto de partida ideal para excursiones en barco y para la práctica de deportes náuticos.
        ...
        <div class="image-container">
            <img src="img/PuertoTapia1.jpg" alt="Castros de Coaña">
            <img src="img/PuertoTapia2.jpg" alt="Paisaje de Castros de Coaña">
        </div>
        <p><br>
        El entorno del puerto de Tapia también ofrece atractivos adicionales, como el faro de Tapia, que se alza sobre un promontorio rocoso y que ofrece vistas panorámicas de la costa. El faro es un símbolo de la villa y un punto de referencia para los navegantes.
            ...
            <br>
            En resumen, el puerto de Tapia de Casariego es un espacio multifacético que combina tradición, actividad económica y atractivo turístico. Su ambiente marinero, sus vistas panorámicas y su oferta de servicios lo convierten en un lugar imprescindible para quienes visitan Tapia.            
