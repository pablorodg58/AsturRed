        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="content" id="contentSection">
                    <div class="section">
                        ...
                        <p>Puerto de Vega es un encantador pueblo costero asturiano conocido por su rica historia marinera y su entorno natural privilegiado. Su puerto pesquero y sus calles empedradas lo convierten en un destino turístico muy valorado.</p>
                        ...
                        <p>Te invitamos a explorar los hermosos rincones de Puerto de Vega, desde sus playas de arena dorada hasta sus senderos naturales, ideales para caminatas y paseos en bicicleta. ¡Ven y descubre lo que tenemos para ofrecerte!</p>
                ...
                <div class="section">
                    ...
                    <div class="grid">
                        <div class="grid-item">
                            <img src="img/ParquePuertoVega.jpg" alt="Mercado local">
                            <p>Explora nuestro mercado local.</p>
                        </div>
                        <div class="grid-item">
                            <img src="img/MuralesPuertoVega.jpg" alt="Recetas tradicionales">
                            <p>Prueba nuestras recetas tradicionales.</p>
                        </div>
                        <div class="grid-item">
                            <img src="img/MuseoPuertVega.jpg" alt="Eventos en el pueblo">
                            <p>Participa en nuestros eventos anuales.</p>
                        </div>
                        <div class="grid-item">
                            <img src="img/LonjaPuertoVega.jpg" alt="Naturaleza alrededor del pueblo">
            ...
            <div class="col-md-3">
                <div class="business-container">
                    ...
                    // Obtener los negocios de Puerto de Vega
                    $query = "SELECT id, username, business_name, profile_pic FROM businesses WHERE address LIKE '%Puerto de Vega%'";
