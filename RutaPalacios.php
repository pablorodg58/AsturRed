...
<head>
    ...
    <title>Ruta de los Palacios</title>
...
<body>
    ...
    <header class="image-banner">
        <img src="img/cabecera-Ruta-Palacios.jpg" alt="cabecera-Plaza-Vegadeo">
        <h2>Ruta de los Palacios</h2>
    </header>

    <!-- Contenido principal -->
    <div class="content">
        <h2 class="text-center">Recorre una Ruta Llena de Palacios que Descubrir</h2>
        <p>
        Esta ruta, diseñada para ser realizada en coche, te permitirá descubrir el rico patrimonio arquitectónico de Vegadeo y sus alrededores. Comenzaremos nuestro recorrido en Vegadeo, la capital del concejo, y nos dirigiremos hacia Piantón, donde nos espera la Casa del Rego, una construcción del siglo XVII rodeada por un impresionante muro de pizarra y que cuenta con un palomar octogonal. Destacan sus poderosos marcos y dinteles de pizarra negra.
...
<br>
Continuaremos nuestro recorrido por las inmediaciones del casco urbano de Vegadeo, donde encontraremos el Palacio de Lastra, del siglo XVI, que cuenta con un pasadizo que conduce desde el edificio hasta el río Eo. En el centro de Vegadeo, podremos admirar el Palacio de Valledor o la Casa del Campo, con su torre ochavada que en su día fue utilizada como fábrica de curtidos.
...
<br>
        ...
        <div class="image-container">
            <img src="img/RutaPalacios1.jpg" alt="Vaca Vegadeo">
            <img src="img/RutaPalacios2.jpg" alt="Kiosko vegadeo">
        </div>
        <p><br>
        Siguiendo la carretera AS-11, llegaremos a Vixande, donde nos sorprenderá el Palacio de Vixande, una construcción espectacular con numerosas ventanas. Cuenta la leyenda que el rey ordenó tapiar una de ellas para que no tuviera más ventanas que el Palacio Real.
            ...
            <br>
            Finalmente, tomaremos la N-640 para llegar a Abres, donde se encuentra el Palacio de El Pividal, con su torre almenada y una capilla que alberga valiosas muestras de talla de los siglos XVII y XVIII.
