        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="content" id="contentSection">
                    <div class="section">
                        ...
                        <p>Tapia de Casariego es un encantador pueblo costero que combina tradición y modernidad. Su historia se remonta a tiempos antiguos, donde la pesca y la agricultura fueron pilares de su economía. Hoy en día, se ha convertido en un destino turístico muy valorado por sus playas y su gastronomía.</p>
                        ...
                        <p>Te invitamos a explorar los hermosos rincones de Tapia, desde sus playas de arena dorada hasta sus senderos naturales, ideales para caminatas y paseos en bicicleta. ¡Ven y descubre lo que tenemos para ofrecerte!</p>
                ...
                <div class="section">
                    ...
                    <div class="grid">
                        <div class="grid-item">
                            <img src="img/FaroTapia.webp" alt="Mercado local">
                            <p>Explora nuestro mercado local.</p>
                        </div>
                        <div class="grid-item">
                            <img src="img/IglesiaTapia.jpg" alt="Recetas tradicionales">
                            <p>Prueba nuestras recetas tradicionales.</p>
                        </div>
                        <div class="grid-item">
                            <img src="img/PlayaTapia.jpg" alt="Eventos en el pueblo">
            ...
            <div class="col-md-3">
                <div class="business-container">
                    ...
                    // Obtener los negocios de Tapia
                    $query = "SELECT id, username, business_name, profile_pic FROM businesses WHERE address LIKE '%Tapia%'";
