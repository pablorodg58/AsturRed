...
<head>
    ...
    <title>Murales de Puerto de Vega</title>
...
<body>
    ...
    <header class="image-banner">
        <img src="img/cabecera-MuralPuertovega.jpg" alt="Plata Tapia">
        <h2>Murales de Puerto de Vega</h2>
    </header>

    <!-- Contenido principal -->
    <div class="content">
        <h2 class="text-center">Pinceladas a un Pueblo Encantador</h2>
        <p>
        Los murales de Puerto de Vega son un elemento distintivo que añade un toque de arte y cultura a este encantador pueblo marinero. Estas obras de arte al aire libre, que se encuentran en diversos puntos del pueblo, representan escenas de la vida marinera, la historia local y la belleza del paisaje asturiano.



<br>
Uno de los murales más destacados se encuentra en el paseo del Baluarte, cerca de la lonja, y representa una escena de la caza de ballenas, una actividad que tuvo una gran importancia en la historia de Puerto de Vega. Este mural, realizado por el artista asturiano Alfonso Iglesias, conocido como "Alfonsín", muestra a los balleneros faenando en el mar Cantábrico, con sus arpones y sus pequeñas embarcaciones.



<br>
Otro mural de interés se encuentra en la plaza del Ayuntamiento, y representa una vista panorámica de Puerto de Vega, con sus casas de colores, su puerto y su iglesia. Este mural, realizado por el artista local José Ramón García, conocido como "Monchu", captura la esencia del pueblo y su ambiente marinero.
        ...
        <div class="image-container">
            <img src="img/Mural1.jpg" alt="Castros de Coaña">
            <img src="img/Mural2.jpg" alt="Paisaje de Castros de Coaña">
        </div>
        <p><br>
        Además de estos murales, Puerto de Vega cuenta con otros elementos artísticos que merecen ser mencionados. En el puerto, se encuentra una escultura de bronce que representa a un pescador, obra del artista asturiano Fernando Alba. Esta escultura, que rinde homenaje a los hombres y mujeres del mar, es un símbolo de la tradición marinera de Puerto de Vega.



            <br>
            En resumen, los murales de Puerto de Vega, junto con otras obras de arte público, contribuyen a crear un ambiente artístico y cultural en este pueblo marinero asturiano. Estas obras de arte, que representan escenas de la vida local y la historia de la región, son un atractivo adicional para quienes visitan Puerto de Vega.            <div class="text-center my-4">
