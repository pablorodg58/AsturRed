...
<body>
  ...
  <header class="image-banner">
    <img src="img/Cabecera-Kartodromo-de-Tapia.webp" alt="Castros de Coaña">
    <h2>Kartodromo de Tapia</h2>
  </header>

  <!-- Contenido principal -->
  <div class="content">
    <h2 class="text-center">¡Vive la emoción del Kartódromo de Tapia!</h2>
    <p>
      El Kartódromo de Tapia, un referente en el karting del norte de España, se erige como fruto de la pasión y el esfuerzo de un equipo con más de 20 años de experiencia en el mundo del motor. Sus orígenes se encuentran en la competición, lo que ha permitido acumular un profundo conocimiento del deporte y sentar las bases para la creación de un espacio dedicado a la emoción y la adrenalina del karting.
<br>
      La visión de sus fundadores trascendió la mera creación de un circuito, buscando ofrecer una experiencia completa y de calidad para todos los públicos. Con el paso del tiempo, el Kartódromo de Tapia ha sabido adaptarse a los nuevos tiempos, incorporando innovaciones como karts eléctricos y de dos tiempos de competición, únicos en el norte de España. Esta apuesta por la modernización y la diversificación de la oferta ha consolidado su prestigio como uno de los kartódromos más destacados de la región.
    </p>

    <div class="image-container">
      <img src="img/Karting1.jpg" alt="Castros de Coaña">
      <img src="img/Karting2.jpg" alt="Paisaje de Castros de Coaña">
    </div>
    <p><br>
      El kartódromo de Tapia, se ha ganado su prestigio gracias a su compromiso con la calidad, la seriedad y la seguridad. El uso de material de alta calidad en prestaciones y seguridad, junto con un equipo de profesionales experimentados, garantiza una experiencia de karting emocionante y segura para todos los usuarios. Además, su ubicación estratégica en Tapia de Casariego, Asturias, lo convierte en un destino atractivo para los amantes del motor de toda la región y más allá.
    </p>
  </div>
  <!-- Contenedor de botones en horizontal -->
  <div class="button-container">
    <a href="MiNegocio.php?username=Kartodromo de Tapia" class="btn btn-custom">
      Ver Perfil del Kartódromo
    </a>
    <a href="Tapia.php" class="btn btn-custom">Volver a Tapia</a>
  </div>
