...
<head>
    ...
    <title>Parque Benigno Blanco</title>
...
<body>
    ...
    <header class="image-banner">
        <img src="img/cabecera-Parque-Benigno-Blanco.webp" alt="Plata Tapia">
        <h2>Parque Benigno Blanco</h2>
    </header>

    <!-- Contenido principal -->
    <div class="content">
        <h2 class="text-center">Las Mejores Playas de Occidente</h2>
        <p>
        El Parque Benigno Blanco, situado en el encantador Puerto de Vega es un espacio verde que ofrece un lugar de esparcimiento y relax para los habitantes de la localidad y sus visitantes. Este parque, que lleva el nombre de un ilustre hijo de Puerto de Vega, Benigno Blanco-Ortiguera y Méndez-Castrillón, es un ejemplo de colaboración entre los vecinos y los emigrantes portoveguenses que contribuyeron a su creación.



<br>
El parque se caracteriza por su ambiente tranquilo y familiar, con amplias zonas verdes, árboles centenarios y áreas de juego para niños. Es un lugar ideal para pasear, descansar y disfrutar del aire libre, con vistas al puerto y al mar Cantábrico.

<br>
Además de su valor como espacio de ocio, el Parque Benigno Blanco también tiene un valor histórico y cultural. Benigno Blanco-Ortiguera y Méndez-Castrillón fue un destacado jurista y diputado provincial, y su legado se refleja en este parque, que es un testimonio de su contribución a la comunidad.
        ...
        <div class="image-container">
            <img src="img/ParqueBenignoBlanco1.jpg" alt="Castros de Coaña">
            <img src="img/ParqueBenignoBlanco2.jpg" alt="Paisaje de Castros de Coaña">
        </div>
        <p><br>
        El parque cuenta con instalaciones para el disfrute de personas de todas las edades. Para los más pequeños, hay zonas de juego con columpios, toboganes y otros elementos recreativos. Para los adultos, hay bancos y zonas de sombra donde relajarse y disfrutar del entorno.
            ...
            <br>
            El Parque Benigno Blanco es un lugar donde se celebran eventos y festividades a lo largo del año, convirtiéndose en un punto de encuentro para la comunidad. Su ambiente acogedor y su valor histórico y cultural lo convierten en un lugar imprescindible para quienes visitan Puerto de Vega.
