...
<body>
    ...
    <header class="image-banner">
        <img src="img/cabecera-osEsquios.jpg" alt="Castros de Coaña">
        <h2>Os Esquíos</h2>
    </header>

    <!-- Contenido principal -->
    <div class="content">
        <h2 class="text-center">Una Aldea de la Asturias mas Rural</h2>
        <p>
        Os Esquíos, una pequeña aldea en el concejo de Taramundi, es un enclave que preserva la rica herencia etnográfica de la región. Este lugar, que ha sido hogar de familias de ferreiros durante generaciones, ofrece a los visitantes una visión auténtica de la vida tradicional asturiana.            <br>
        El principal atractivo de Os Esquíos es su museo etnográfico, que alberga una colección de objetos y herramientas que reflejan el modo de vida de la zona. Entre las piezas expuestas, se encuentran utensilios de labranza, herramientas de oficios tradicionales y objetos de uso cotidiano, todos ellos testigos de la historia y las costumbres locales.

<br>
Además del museo, Os Esquíos cuenta con un taller de forja en activo, donde se siguen elaborando navajas y cuchillos siguiendo técnicas ancestrales. Los visitantes tienen la oportunidad de observar el trabajo de los artesanos y conocer de cerca el proceso de fabricación de estas piezas.


        </p>

        <div class="image-container">
            <img src="img/osEsquios1.jpg" alt="Castros de Coaña">
            <img src="img/OsEsquios2.jpg" alt="Paisaje de Castros de Coaña">
        </div>
        <p><br>
        El entorno de Os Esquíos también es de gran belleza, con paisajes de montaña, bosques y prados que invitan a la exploración. La arquitectura tradicional de la aldea, con sus casas de piedra y tejados de pizarra, contribuye a crear un ambiente pintoresco y acogedor.




            <br>
            Os Esquíos es un lugar donde el tiempo parece haberse detenido, un refugio de tradiciones y costumbres que han perdurado a lo largo de los siglos. Su valor etnográfico y su entorno natural lo convierten en un destino imprescindible para quienes buscan conocer la Asturias más auténtica.        <div class="text-center my-4">
