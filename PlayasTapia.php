...
<body>
    ...
    <header class="image-banner">
        <img src="img/cabecera-Playa-Tapia.jpg" alt="Plata Tapia">
        <h2>Playas de Tapia</h2>
    </header>
    ...
    <div class="content">
        ...
        <p>
        Tapia de Casariego es un tesoro de la costa asturiana. Despliega una rica variedad de playas que cautivan a visitantes con sus características únicas y su belleza natural. Entre ellas, destaca la Playa de Anguileiro, La Furada y San Blas que se unen con la bajamar formando un extenso arenal. La Playa de Penarronda, declarada Monumento Natural, es famosa por su icónica roca con un agujero en el centro. La Playa de Santa Gadea/Pantorga (A Ribeira), la Playa Mexota (A Mixota), la Playa de Serantes/Sarello (Sareyo), la Playa La Paloma/Esteiro y la Playa de la Urbanización/Entreplayas completan el abanico de opciones, ofreciendo desde espacios tranquilos para el relax hasta zonas con oleaje ideal para la práctica del surf.


<br>
Un atractivo singular de Tapia es su piscina natural de agua salada, conocida como la piscina Antonio Alonso Bedia "Toño del Moderno". Inaugurada en 2010, esta piscina aprovecha una antigua cetárea, un espacio destinado a la cría de mariscos, y se ha convertido en un lugar de esparcimiento popular. Su ubicación junto al paseo marítimo y su entrada gratuita la hacen accesible a todos.
        ...
        <div class="image-container">
            <img src="img/playa1.jpg" alt="Castros de Coaña">
            <img src="img/Playa2.jpg" alt="Paisaje de Castros de Coaña">
        </div>
        <p><br>
        La piscina natural ofrece una alternativa segura y relajante para el baño, especialmente cuando el mar presenta condiciones menos favorables. Sus aguas saladas y su entorno natural la convierten en un espacio único donde disfrutar del mar con tranquilidad.
            ...
            <br>
            En resumen, las playas de Tapia de Casariego y su piscina natural ofrecen una combinación perfecta de belleza natural, diversidad de opciones y espacios para el relax y el disfrute del mar.
